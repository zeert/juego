...
window.onload = function(){
    ...
    game.onload = function(){
         ...
         */
        oso.image = game.assets["chara1.png"];
         ...
         */
        oso.addEventListener("enterframe", function(){
            /**
         ...
         */
        oso.addEventListener("touchstart", function(){
            /**
             * クマを game.rootScene から削除する。
             * Group#addChild の逆は Group#removeChild。
             */
            game.rootScene.removeChild(oso);
        });
    };
